function dy=ad_ab(t,y);% script file ABC_ab.m
...
Iar=A(4,1)*y(1)+A(4,2)*y(2)+A(4,3)*y(3)+A(4,4)*y(4)+A(4,5)*y(5);
Ibr=A(5,1)*y(1)+A(5,2)*y(2)+A(5,3)*y(3)+A(5,4)*y(4)+A(5,5)*y(5);
%================================================================
...
dy(4)=-Rr*Iar-y(6)/sqrt(3)*(2*y(5)+y(4));
dy(5)=-Rr*Ibr+y(6)/sqrt(3)*(2*y(4)+y(5));
%=====================================
% Equetions of torque,
if t<=0.05
    Mc=0;
