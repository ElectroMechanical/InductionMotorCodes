...
% jornal "Elektrichestvo" - N4, 1998 y. 
% Insrution: zapustie file Iden1.m, zatem file Iden2.m,
%=====================================
%     VVOD DANNIX AD  
%==============================
%      NOMINAL REZIM
%==============================
P2n=15e3; % nominal power [Wt]
Un=380; f1=50;% nominal faznoe U and chastota ceti
m=3; p=2; % chislo faz and chislo polusov
kpdn=0.89; cosn=0.89; % nominal kpd and cos(fi)
Km=2; Kp=1.3; %Km=Mmax/Mnom; Kp=Mkz/Mnom;
Ki=7.0; %  Ki=I1kz/I1nom
n1=60*f1/p;% sinxron. chastota [ob/min]
nr=1476; % chastota rotora [ob/min]
...
disp('  REZULTS OF CALLCULATION PARAMETRS T-obraznoi CXEM ZAMECHENIA AD');
disp(['    ','P2n=',x11,'[Wt]']); 
disp('  ==============================================================')
...
disp('  ===================================================');
disp('     Rotors resistans  R2k and X2k pri S=1 ');
disp(['  R2k= ',x9,'[Om];','    ','X2k= ', x10, '[Om];']);
disp('  ====================================================');
