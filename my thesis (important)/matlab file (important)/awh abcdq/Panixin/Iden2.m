% Paschet  pabochix xap-k AD
% Instruction: zapustite file Iden1.m, zatem file Iden2.m
clear;
%=======================================
load dan.mat
%=======================================
...
Zn=n1*(R1^2+sqrt(R1^2+(X1+C1*X2)^2));
Mmax=4.77*m*Un^2/Zn;
Km=Mmax/M(mn);
...
set(ht,'Fontsize',14,'FontAngle','italic','Fontweight','bold');
...
ht1=title('  Slip s');
set(ht1,'Fontsize',14,'FontAngle','italic','Fontweight','bold');
%============================================
disp('                   End of program ');
disp('  ======================================');
