...
% INSTRUCHION: zapustite file Iden1d.m, zatem file Iden2d.m
%clc; 
%clear;
clf;
%=======================================
...
ht1=title('Grafik M=f(s) ');
set(ht1,'Fontsize',14,'FontWeight','bold');
%=======================================
subplot(1,2,2);
axis('off');
h1=text(0.1,1,'Nominal rezim','FontSize',12);
h1=text(0.1,0.95,'-------------------------');
h1=text(-0.2,0.9,sprintf('P2n= %gWt;',P2x),'FontSize', 10);
h1=text(0.45,0.9,sprintf('P1n= %gWt;',P1x),'FontSize', 10);
h1=text(-0.2,0.8,sprintf('Sn= %g;',sx),'FontSize', 10);
h1=text(0.45,0.8,sprintf('Mn= %g N*m;',Mx),'FontSize', 10);
h1=text(-0.2,0.7,sprintf('kpd= %g;',kpdx),'FontSize', 10);
h1=text(0.45,0.7,sprintf('cos(fi)= %g;',cosx),'FontSize', 10);
h1=text(-0.2,0.6,sprintf('I1n= %gA;',I1x),'FontSize', 10);
h1=text(0.45,0.6,sprintf('n2= %gob/min;',nx ),'FontSize', 10);
h1=text(0.1,0.5,'Rezim Mmax','FontSize', 12);
h1=text(0.1,0.45,'----------------','FontSize', 12);
h1=text(-0.2,0.4,sprintf('Km= %g;',Km),'FontSize', 10);
h1=text(0.45,0.4,sprintf('Skr= %g;',Skr),'FontSize', 10);
h1=text(0.1,0.3,'Rezim KZ','FontSize', 12);
h1=text(0.1,0.25,'-------------','FontSize', 12);
h1=text(-0.2,0.2,sprintf('Kp= %g;',Kp),'FontSize', 10);
h1=text(0.45,0.2,sprintf('Ki= %g;',Ki),'FontSize', 10);
disp('                 End of program ');
disp('  ======================================');
% The end;