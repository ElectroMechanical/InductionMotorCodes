...
%=============================================
%==================================
% Vvod  new parametrs AD
%==================================
disp('    AFTER INPUT NEW VALUE - push the button <<ENTER>>');
k=1;
 while k<10
    k=menu('What will vary ',...
    sprintf('Power- Snom=%g Wt ',P2n),...
    sprintf('Voltage- Unom=%g V ',Un),...
    sprintf('Frequency- f1=%g Hz ',f1),...
    sprintf('Number par of poles- p=%g o.e. ',p),...
    sprintf('Coefficient power-cos(fi)=%g o.e ',cosn),...
    sprintf('Efficiency- kpd=%g o.e ',kpdn),...
    sprintf('Coefficient- Km=%g o.e ',Km),...
    sprintf('Coefficient- Kp=%g o.e ',Kp),...
    sprintf('Coefficient- Ki=%g o.e ',Ki),...
        'Nothinng not will vary');
     if k==1,
P2n=input([sprintf(' Initial value Snom=%g',P2n)...
        '  Wt, New value P2n= ']);
     elseif k==2,
...
p=input([sprintf(' Initial value p=%g',p)...
        '  o.e, New value p= ']);
      elseif k==5
cosn=input([sprintf(' Initial value cos(fi)=%g',cosn)...
        '  o.e., New value cos(fi)= ']);
      elseif k==6,
kpdn=input([sprintf(' Initial value kpdn=%g',kpdn)...
        '  o.e, New value kpdn= ']);
      elseif k==7,
Km=input([sprintf(' Initial value Km=%g',Km)...
        ' o.e, New value Km= ']);
     elseif k==8,
Kp=input([sprintf(' Initial value Kp=%g',Kp)...
        ' o.e , New value Kp= ']);
      elseif k==9,
Ki=input([sprintf(' Initial value Ki=%g',Ki)...
        ' o.e, New value Ki= ']);
         end
  end 
%=============================================
